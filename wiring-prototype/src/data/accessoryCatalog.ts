import type { AccessoryItem, CableSpec, TerminalLugSpec } from '../types';

// ── Cable Specifications ──
// Current ratings based on Victron Wiring Unlimited, Chapter 4.1
// Total cable length = positive + negative run
...
export const SOLAR_CABLE: CableSpec = {
  gauge: 6, type: 'solar', color: 'black/red pair', pricePerMetre: 2.80, maxCurrentRating5m: 18, maxCurrentRating10m: 9,
};

export const AC_CABLE_2_5: CableSpec = {
  gauge: 2.5, type: 'H07RN-F', color: '3-core (brown/blue/green-yellow)', pricePerMetre: 3.50, maxCurrentRating5m: 16, maxCurrentRating10m: 16,
};

export const AC_CABLE_1_5: CableSpec = {
  gauge: 1.5, type: 'H07RN-F', color: '3-core (brown/blue/green-yellow)', pricePerMetre: 2.50, maxCurrentRating5m: 10, maxCurrentRating10m: 10,
};

export const BONDING_CABLE: CableSpec = {
  gauge: 4, type: 'bonding', color: 'green/yellow', pricePerMetre: 1.20, maxCurrentRating5m: 12, maxCurrentRating10m: 6,
};

// ── Terminal Lugs ──
// Format: cableSize-studSize (e.g., 70-8 = 70mm² cable, M8 stud)
